...
dbc.Card(
  dbc.CardBody([
    dbc.Row(
        [
            dbc.Label("Luas Tanah", width=2),
            dbc.Col(
                [
                    dcc.Input(id='lt-input', type='number', placeholder='Enter LT (m2)'),
                    html.Br(),
                    dbc.FormText("Masukkan luas tanah dalam meter persegi (m2).")
                ],
                width=5,
            ),
        ],
        ...
        [
            ...
            dbc.Col(
                [
                    ...
                    dbc.FormText("Pilih ketersediaan air.")
                ],
                width=5,
            ),
        ],
  ...
  dbc.Row(
    [
        ...
        dbc.Col(
            ...
            dbc.FormText("Pilih ketersediaan listrik.")
            ],
            width=5,
        ),
    ],
  ...
  dbc.Row(
    [
        dbc.Label("Jarak Ke Pusat Kota",  width=2),
        dbc.Col(
            [
            dcc.Input(id='distance-input', type='number', placeholder='Enter distance_ke_pusatkota'),
            html.Br(),
            dbc.FormText("Masukkan jarak ke pusat kota dalam kilometer.")
            ],
            width=5,
        ),
    ],
    ...
    dbc.Row(
      [
          dbc.Label("Lebar Jalan Depan",  width=2),
          dbc.Col(
              [
              dcc.Input(id='lebar-jalan-input', type='number', placeholder='Enter Lebar Jalan Depan (m)'),
              html.Br(),
              dbc.FormText("Masukkan lebar jalan depan dalam meter.")
              ],
              width=5,
          ),
      ],
   ...
   dbc.Row(
     [
         ...
         dbc.Col(
             ...
             dbc.FormText("Masukkan cluster tanah berdasarkan peta geospatial.")
             ],
             width=5,
         ),
     ],
  ...
  dbc.Row(
    [
        ...
        dbc.Col(
            ...
            dbc.FormText("Pilih peruntukan tanah.")
            ],
            width=5,
        ),
    ],
   ...
   dbc.Row(
     [
         dbc.Label("Hak Atas Properti",  width=2),
         dbc.Col(
             [
             dcc.Dropdown(
                 id='hap-dropdown',
             ...
             dbc.FormText("Pilih hak atas properti pada tanah.")
             ],
             width=5,
         ),
     ],
   ...
   dbc.Row(
     [
         dbc.Label("Kota/Kabupaten",  width=2),
         dbc.Col(
             [
             dcc.Dropdown(
             ...
             dbc.FormText("Pilih kota/kabupaten.")
             ],
             width=5,
         ),
     ],
   ...
   dbc.Row(
     [
         dbc.Label("Bentuk Tapak",  width=2),
         dbc.Col(
             [
             dcc.Dropdown(
             ...
             dbc.FormText("Pilih bentuk tapak tanah.")
             ],
             width=5,
         ),
     ],
    ...
    dbc.Row(
      [
          dbc.Label("Kondisi Wilayah Sekitar",  width=2),
          dbc.Col(
              [
              dcc.Dropdown(
              ...
              dbc.FormText("Pilih kondisi wilayah sekitar pada tanah.")
              ],
              width=5,
          ),
      ],
...
dbc.Row(
    [
        dbc.Label("Kondisi Tapak",  width=2),
        dbc.Col(
            [
            dcc.Dropdown(
            ...
            dbc.FormText("Pilih kondisi tapak pada tanah.")
            ],
            width=5,
        ),
    ],
    ...
    dbc.Row(
        [
            dbc.Label("Prediksi",  width=2),
            dbc.Col(
                dbc.Button("Hitung Prediksi", color="primary", className="me-1",id='predict-button'),
    ...
    dbc.Row(
        [
            dbc.Label("Hasil Prediksi",  width=2),
            dbc.Col(
    ...
    style={"border-radius": "25px"," background": "#73AD21","padding": "20px","color":"secondary"}
     )
])
####################### CALLBACKS ################################
@callback(
